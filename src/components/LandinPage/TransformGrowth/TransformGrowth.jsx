      ...
      <Col lg={12} className="px-0">
        ...
        <Div className="lendo__transform-growth-content shadow bg-body">
          <Div className="lendo__transform-growth-content-wrapper">
            ...
            <Text className="py-4">
              Designed specifically for the needs of small and medium businesses, Lendo offers instant short-term
              finance-against-invoice solutions so your company’s cash flow does not suffer every time you accommodate
              your client with extended or flexible payment terms.
            </Text>
