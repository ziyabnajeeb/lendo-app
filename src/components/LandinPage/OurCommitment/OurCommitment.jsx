          ...
          <Row className='lendo__our-commitment-content align-items-center justify-content-center'>
            ...
            <Col lg={6}>
              <div className='lendo__our-commitment-content-right'>
                ...
                <p className='fw-bold mb-3'>Compliance is not merely a function or department here at Lendo.</p>
                <p>We hold our business conduct according to Islamic Ethics inclusive of principles and values. We strive to continuously earn the trust of our customers, partners and suppliers by adhering to the required laws, regulations, stipulations and ethics mandated by the Shariah Board.</p>
                <Button size='lg'>
